 ...
 */
class Version20171004123113 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(150) NOT NULL, text LONGTEXT NOT NULL, date DATETIME NOT NULL, url VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5A8A6C8DF47645AE (url), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
